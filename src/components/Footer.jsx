...
const Footer = () => {
    return (
        <footer class="md:mt-80 lg:mt-0 mt-[1500px] bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10 flex justify-center">
            <div class="container">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
                        <div class="w-full mb-10">
                            ...
                            <p class="text-base text-body-color mb-7">
                                SocialShadow vous aide à devenir anonyme sur internet.
                            </p>
                    ...
                    <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
                        <div class="w-full mb-10">
                            <h4 class="text-dark text-lg font-semibold mb-9">Utilitaire</h4>
                            <ul>
                                <li>
                                    <a
                                        href="javascript:void(0)"
                    ...
                    <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
                        <div class="w-full mb-10">
                            <h4 class="text-dark text-lg font-semibold mb-9">Légal</h4>
                            <ul>
                                <li>
                                    <a
                                        href="javascript:void(0)"
                    ...
                    <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
                        <div class="w-full mb-10">
                            <h4 class="text-dark text-lg font-semibold mb-9">À propos</h4>
                            <ul>
                                <li>
                                    <a
                                        href="javascript:void(0)"
                    ...
                    <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
                        <div class="w-full mb-10">
                            <h4 class="text-dark text-lg font-semibold mb-9">Nous suivre</h4>
                     ...
                     "
                            ...
                            <p class="text-base text-body-color">&copy; 2022 SocialShadow</p>
                        </div>
                    </div>
                </div>
            </div>
