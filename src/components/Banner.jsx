    ...
    return (
        <div className="ml-[5vw] flex lg:flex-row md:flex-row flex-col">
            <div className="mt-40">
                ...
                {getLogin ? <Link to="/cleardata"><button className="bg-sky-500 px-5 py-3 font-medium rounded-md text-white hover:bg-sky-400 mt-14 duration-100 hover:mt-12">Supprimer mes données !</button></Link> : <Link to="/login"><button className="bg-sky-500 px-5 py-3 font-medium rounded-md text-white hover:bg-sky-400 mt-14 duration-100 hover:mt-12">Supprimer mes données !</button></Link>}
            </div>
